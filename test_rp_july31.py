...
if output.returncode == 0:
    ...
    sys.exit("Unable to contact the device under test over Ethernet interface")
...
# check see if TRU Manager(backend) is accessible
output = run_out('ping -c 2 www.google.com')
if '2 packets transmitted, 2 packets received' in output:
...
class SmokeTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        log_yellow('[                         SStart of the Test Suite Execution : ' + 
                   time.strftime("%B%d, %Y %I:%M:%S%p %Z") + '                        ]')
        log_blue('[================================================================================================================]')
